...
/*------------------------------------------------------------------------------+
| MagneticOne                                                                   |
| Copyright (c) 2020 MagneticOne.com <contact@magneticone.com>                  |
| All rights reserved                                                           |
+-------------------------------------------------------------------------------+
...
class M1_Config_Adapter
{
  ...
  public static function detectRootFolder()
  {
    ...
    $isPrestaShopPlugin = stripos($_SERVER['REQUEST_URI'], 'cart2cart-prestashop-migration') !== false;
...
class M1_Config_Adapter_Shopware extends M1_Config_Adapter
{
  public function __construct()
  {
    if (@file_exists(M1_STORE_BASE_DIR .  '.env') || @file_exists(M1_STORE_BASE_DIR .  '../.env')) {
      ...
      if ($version = @file_get_contents(M1_STORE_BASE_DIR . 'public/recovery/install/data/version')) {
...
define('M1_BRIDGE_DOWNLOAD_LINK', 'https://dev.shopping-cart-migration.com/api.get.bridge');
